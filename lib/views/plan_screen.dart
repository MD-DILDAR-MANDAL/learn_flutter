        ...
        builder: (context, plans, child){
          ...
          return Column(
            children: [
              ...
              SafeArea(child: 
              Text(currentPlan.completenessMessage)),
            ],);},),
  ...
  Widget _buildAddTaskButton(BuildContext context) {
    ...
    return FloatingActionButton(
      ...
      onPressed: (){
        ...
        int planIndex = 
            planNotifier.value.indexWhere((p) => 
            p.name == currentPlan.name);
        List<Task> updatedTasks = 
        List<Task>.from(currentPlan.tasks)..add(const Task());
        planNotifier.value = 
        List<Plan>.from(planNotifier.value)..[planIndex] = 
        Plan(
  ...
  return ListTile(
    leading: Checkbox(
      ...
      onChanged: (selected){
          ...
          planNotifier.value = 
          List<Plan>.from(planNotifier.value)
            ..[planIndex] = Plan(
              name: currentPlan.name,
              tasks: 
